...
/**
 * Könnyű osztály, itt a kiválasztott szint --> könnyé kezelése zajlik
 * Ami azt jelenti, hogy 1300 golddal rendelkezik a játékos, és ezt tudja elkölteni kedvére
 * Majd itt küldjük el az adatokat is a GameControlnak, persze csak a könnyű résznek
 */
...
public int egyseg=0;
    ...
    /**
     * @param x Amennyibe kerül az adott tulajdonság
     * @return  Mennyi pénzünk maradt
     */
    ...
    /**
     * @param x Amennyibe kerül az adott tulajdonság
     * @return  Mennyi pénzünk lesz miután azt visszakaptuk
     */
    public long vissza(long x) {
        if (penz_ertek + kerul <= 1300) {
            penz_ertek += kerul;
            penz.setText("" + penz_ertek);
