...
/**
 * Közepes osztály, itt a kiválasztott szint --> közepes kezelése zajlik
 * Ami azt jelenti, hogy 1000 golddal rendelkezik a játékos, és ezt tudja elkölteni kedvére
 * Majd itt küldjük el az adatokat is a GameControlnak, persze csak a közepes résznek
 */
public class MediumControl {
